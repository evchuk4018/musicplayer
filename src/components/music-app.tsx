  ...
  return (
    <div className="app-shell">
      <main className="app-main" data-active-acquisition-jobs={activeJobCount}>
        {page === 'home' && <HomeView state={{ ...initialState, library }} onPlay={(track) => void playTrack(track)} onOpenPlaylist={(playlist) => { setOpenPlaylist(playlist); setPage('library'); }} onToggleSpeedDial={toggleSpeedDial} onMoveSpeedDial={moveSpeedDial} />}
