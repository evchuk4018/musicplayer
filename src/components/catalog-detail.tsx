...
type CatalogDetailProps = {
  ...
  onArtistRadio: (track: Track) => void;
};

export function CatalogDetail({ detail, onBack, onPlay, onLike, onAdd, onSave, onOpenAlbum, onArtistRadio }: CatalogDetailProps) {
